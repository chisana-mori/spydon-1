...
func NewFindingToAlertConverter(ginCtx *gin.Context, handler *IngestHandler, finding *RobustaFinding, rawPayload []byte) *FindingToAlertConverter {
...
func NewFindingToAlertConverterWithContext(ctx context.Context, handler *IngestHandler, finding *RobustaFinding, rawPayload []byte) *FindingToAlertConverter {
	return &FindingToAlertConverter{
		ctx:            ctx,
		ginCtx:         nil,
		handler:        handler,
