...
// Response 统一响应结构（复制于 api/response.go，避免循环依赖）
...
// PaginatedResponse 分页响应结构（与 internal/api 保持一致）
...
func Created(c *gin.Context, data interface{}) {
	c.AbortWithStatusJSON(constants.StatusCreated, Response{Data: data}.toMap())
}
