                                ...
                                <FormItem>
                                    <div className="flex justify-between items-center">
                                        ...
                                        <Button
                                            ...
                                            onClick={() => formatKubeConfig(field.value || '')}
                                        >
                                            格式化
                                        </Button>
                                    </div>
                                    <FormControl>
                                        <Textarea
                                            ...
                                            onBlur={() => {
                                                field.onBlur()
                                                // Optional: Auto-format on blur? Maybe too intrusive, let's keep it manual button + validation
                                            }}
                                        />
                                    </FormControl>
                                    <FormDescription>
                                        输入标准的 KubeConfig YAML 内容，用于连接集群。
                                    </FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
