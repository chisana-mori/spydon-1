...
export function DictionarySelect({
    ...
    const selectedItem = items.find((item: any) => item.key === value)
    ...
    React.useEffect(() => {
        ...
        // 使用 mousedown 而非 click，确保在 Dialog 内也能正常工作
    ...
    return (
        ...
        >
            ...
            <button
                ...
                disabled={disabled}
                className={cn(
                    "h-9 w-full flex items-center justify-between px-3 py-2",
            ...
            >
                {selectedItem ? (
                    <span className="flex items-center gap-2 overflow-hidden">
                        ...
                        <span className="truncate">{selectedItem.value}</span>
                    </span>
                ) : (
            ...
            {open && (
                <div
                    ...
                    onMouseDown={(e) => {
                        // 阻止 mousedown 冒泡，防止触发 Dialog 的 outside click
                        e.stopPropagation()
                    }}
                >
                    {/* Search Input */}
