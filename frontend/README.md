...
Global styles live in `src/app/globals.css` and follow the rules described in `../frontend-design.mdc`. Components use Tailwind utility classes together with custom UI primitives in `src/components/ui`.
